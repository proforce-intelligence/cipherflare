...
async def list_monitoring_jobs(
    ...
    Returns data compatible with frontend MonitoringJob interface
    """
    try:
        ...
        logger.error(f"[MonitoringJobs] List failed: {e}")
        raise HTTPException(status_code=500, detail="Failed to list monitoring jobs")
...
async def get_monitoring_job(
    ...
    try:
        ...
        logger.error(f"[MonitoringJobs] Get detail failed: {e}")
...
async def pause_monitoring_job(
    ...
    try:
        ...
        logger.error(f"[MonitoringJobs] Pause failed: {e}")
...
async def resume_monitoring_job(
    ...
    try:
        ...
        logger.error(f"[MonitoringJobs] Resume failed: {e}")
...
async def delete_monitoring_job(
    ...
    try:
        ...
        logger.error(f"[MonitoringJobs] Delete failed: {e}")
